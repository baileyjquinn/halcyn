...
/* ──────── Chatbot is now imported from ../components/features/Chatbot ──────── */
...
export default function SouthEndPlumbingDemo() {
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <Chatbot theme="blue" icon="💬" businessName="South End Plumbing" issues={[
        { value: 'Burst pipe - emergency', label: '🚨 Burst pipe — Emergency!' },
        { value: 'Water heater broken', label: '🔥 Water heater broken' },
        { value: 'Clogged drain', label: '🚿 Clogged drain' },
        { value: 'Leaky faucet', label: '💧 Leaky faucet' },
        { value: 'Sewer backup', label: '⚠️ Sewer backup' },
        { value: 'Toilet not flushing', label: '🚽 Toilet not flushing' },
