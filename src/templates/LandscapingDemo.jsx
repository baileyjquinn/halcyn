...
function DemoSections() {
  ...
  async function handleSubmit(e) {
    ...
    const { error } = await supabase.from('leads').insert([{ name: form.name, email: form.email, phone: form.phone || null, message: form.message || 'Artificial Turf Products demo interest', source: 'artificial-turf-demo', business_id: 'biz-artificial-turf-products' }])
